#!/usr/bin/env python3
"""
pipeline_dos.py - Ejercicio 4.1 de Pipes.

Pipeline de dos comandos: equivalente a `ls -la | grep '.py'`.
...
def pipeline_dos_comandos(cmd1, args1, cmd2, args2):
    """Ejecuta cmd1 | cmd2 usando os.pipe() y os.fork()."""
...
if __name__ == "__main__":
    print("=== ls -la | grep '.py' ===", file=sys.stderr)
